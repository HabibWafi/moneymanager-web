    ...
    <Modal open={open} onClose={onClose} title="Tambah Pengeluaran Extra">
      <div className="space-y-4">
        ...
        <div>
          ...
          <input value={desc} onChange={(e) => setDesc(e.target.value)} placeholder="Contoh: Beli groceries" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400" />
        </div>
        <div>

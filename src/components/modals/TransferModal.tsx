    ...
    <Modal open={open} onClose={onClose} title="Transfer Antar Rekening">
      <div className="space-y-4">
        <div>
          ...
          <select value={dari} onChange={(e) => setDari(e.target.value)} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400">
        ...
        <div>
          ...
          <select value={ke} onChange={(e) => setKe(e.target.value)} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400">
            {banks.map((b) => <option key={b.id} value={b.id}>{b.nama}</option>)}
          </select>
        </div>
        <div>
        ...
        <div>
          ...
          <input value={ket} onChange={(e) => setKet(e.target.value)} placeholder="Opsional" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400" />
        </div>
